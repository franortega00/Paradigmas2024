...
--inOrderR (Rou lista_ciudades) "" ciudad | notElem ciudad lista_ciudades = False
inOrderR (Rou lista_ciudades) ciudad1 ciudad2 | ciudad1 `notElem` lista_ciudades = False
                                              | ciudad2 `notElem` lista_ciudades = False
